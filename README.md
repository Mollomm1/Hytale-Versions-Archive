...
all those .rar files contain a `start.bat` or `start.sh` file to start an fake-online mode game session, you can edit your character and join lan servers, those game directories (including save file and mods) are portable.
